package br.usjt.fabricio.deswebmob.ciclodevida.Util;
...
public class Utils {
    ...
    private static br.usjt.fabricio.deswebmob.ciclodevida.Util.StatusTracker mStatusTracker = br.usjt.fabricio.deswebmob.ciclodevida.Util.StatusTracker.getInstance();
