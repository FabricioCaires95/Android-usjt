...
public class ListarFilmesActivity extends AppCompatActivity {
    ...
    public static final String FILME = "br.usjt.fabricio.deswebmob.pipocaandroid.filme";
    Activity atividade;
    Filme filme;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FilmesAdapter(this, filmeList);
    ...
    private class WebServiceClient extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String json) {
            ...
            try {
                filmeList.clear();
                Gson gson = new Gson();
                ListFilmesData films = gson.fromJson(json, ListFilmesData.class);
